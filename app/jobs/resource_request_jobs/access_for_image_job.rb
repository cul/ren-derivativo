...
module ResourceRequestJobs
  class AccessForImageJob < ApplicationJob
    include ResourceRequestJobs::ProcessingHelpers

    queue_as :resource_request_access_for_image

    # Creates an access copy for a image resource.
    ...
    def validate_options!(options)
      ...
      validate_required_option!(options, 'rotation')
      true
    end
