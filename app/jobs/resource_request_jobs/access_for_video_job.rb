...
module ResourceRequestJobs
  class AccessForVideoJob < ApplicationJob
    include ResourceRequestJobs::ProcessingHelpers

    queue_as :resource_request_access_for_video

    # Creates an access copy for a video resource.
    ...
    def validate_options!(options)
      validate_required_option!(options, 'format', ['mp4'])
      true
    end
