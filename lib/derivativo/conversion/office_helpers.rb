  ...
  module Conversion
    module OfficeHelpers
      ...
      def self.office_convert_to_pdf(src_file_path:, dst_file_path:)
        office_convert_to_pdf_impl(src_file_path: src_file_path, dst_file_path: dst_file_path, soffice_binary_path: soffice_binary_path_from_config_or_path)
      ...
      def self.office_convert_to_pdf_impl(src_file_path:, dst_file_path:, soffice_binary_path:, compression_integer: 80)
        ...
        Derivativo::FileHelper.working_directory_temp_dir('office_temp_homedir') do |office_temp_homedir|
          ...
          Derivativo::FileHelper.working_directory_temp_dir('office_temp_outdir') do |office_temp_outdir|
            # Run conversion
            Open3.capture2(cmd_to_run = conversion_command(soffice_binary_path, src_file_path, office_temp_homedir.path, office_temp_outdir.path))
