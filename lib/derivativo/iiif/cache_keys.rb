module Derivativo::Iiif::CacheKeys
  ...
  PROPERTY_CACHE_KEYS = [ORIGINAL_IMAGE_DIMENSIONS_KEY, SCALE_FACTORS_KEY, IS_RESTRICTED_SIZE_IMAGE_KEY, REPRESENTATIVE_RESOURCE_DC_TYPE_KEY, PLACEHOLDER_IMAGE_TYPE_KEY, REPRESENTATIVE_RESOURCE_ID_KEY]
end