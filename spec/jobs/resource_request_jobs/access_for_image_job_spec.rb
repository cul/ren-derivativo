...
RSpec.describe ResourceRequestJobs::AccessForImageJob do
  ...
  describe '#perform' do
    before do
      ...
      expect(Hyacinth::Client.instance).to receive(:upload_file_to_active_storage).with(/#{'working_directory'}.+/, 'access.png').and_return('some-signed-id')
